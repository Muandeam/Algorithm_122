...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, transform.right, obstacleLayer);
        ...
        if (hit.collider != null)
        {
            ...
            Vector2 avoidanceDirection = Vector2.Perpendicular(transform.right).normalized;
